...
export default {
  ...
  add(context, item) {
    Axios.post(`${cleaningManagerAPI}/api/v1/address/add`, item,{
        headers: {
  ...
  remove(context, id){
    Axios.post(`${cleaningManagerAPI}/api/v1/address/remove`, {id:id},{
        headers: {
          Authorization: Authentication.getAuthenticationHeader(context)
        }})
      .then(() => {
  ...
  edit(context, item){
    Axios.post(`${cleaningManagerAPI}/api/v1/address/edit`, item,{
        headers: {
          Authorization: Authentication.getAuthenticationHeader(context)
        }})
      .then(() => {
