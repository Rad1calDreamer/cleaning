...
export default {
  ...
  add(context, item) {
    Axios.post(`${cleaningManagerAPI}/api/v1/management-company/add`, item,{
        headers: {
  ...
  remove(context, id){
    Axios.post(`${cleaningManagerAPI}/api/v1/management-company/remove`, {id:id},{
        headers: {
          Authorization: Authentication.getAuthenticationHeader(context)
        }})
      .then(() => {
  ...
  edit(context, item){
    Axios.post(`${cleaningManagerAPI}/api/v1/management-company/edit`, item,{
        headers: {
          Authorization: Authentication.getAuthenticationHeader(context)
        }})
      .then(() => {
